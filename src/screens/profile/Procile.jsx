            ...
            <div class="app__responsive">
              ...
              {/* Top Navbar */}
                <div class="app__top__nav">
                  ...
                  <div class="top__nav__cols">
                    <center>
                      <div class="top__nav__title">Profile</div>
                    </center>
                  </div>
              ...
              {/* User details */}
                ...
                <div class="profile__records__section">
                  <div class="profile__records__section__col" onClick={() => navigate('/game-history')}>
                  ...
                  {/* Recent Transaction */}
                  <div class="profile__records__section__col" style={{marginTop: 20}} onClick={() => navigate('/recent-transaction')}>
                    <div class="profile__records__section__col__left">
                      <div class="profile__record__section__col__icon">
                        <svg
                          stroke="currentColor"
                ...
                <div class="profile__records__section">
                 {/* Follow us */}
                  <div class="profile__records__section__col" onClick={() => navigate('/follow-us')}>
                    <div class="profile__records__section__col__left">
                      <div class="profile__record__section__col__icon">
                        <svg
                          stroke="currentColor"
                ...
                {/* Sign out */}
                <div class="profile__records__section">
                  <div class="profile__records__section__col" onClick={() => setShowModal(true)}>
                    <div class="profile__records__section__col__left">
                      <div class="profile__record__section__col__icon">
                        <svg
                          stroke="currentColor"
